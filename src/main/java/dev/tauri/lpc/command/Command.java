...
public class Command {
    ...
    private final List<AbstractCommand> subCommands = new LinkedList<>();
    ...
    public static final Command LPC_COMMAND_BASE = new Command("lpc");
    ...
    public void registerCommands(CommandDispatcher<CommandSourceStack> dispatcher) {
        ...
        LPC.logger.info("Successfully registered Commands!");
        isRegistered = true;
    }
    ...
    public MutableComponent getCommandTextComponentForHelp(AbstractCommand cmd) {
    ...
    public void sendUsageMess(CommandSourceStack sender, AbstractCommand cmd) {
    ...
    public static class CommandHelp extends AbstractCommand {
        public CommandHelp(Command baseCommand) {
            super(baseCommand);
        }
